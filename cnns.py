...
class Decoder(nn.Module):
    def __init__(self, output_channels, embed_size, channels_mult=1, final_activation=None):
        ...
        self.fc = nn.Linear(self.embed_size, 512 * 4 * 4)  # [B*T, 512*4*4]
        ...
        if final_activation is not None:
            ...
            self.final_activation = nn.Sigmoid()  # デフォルトはSigmoid
        # 修正点: 出力層の活性化関数をTanhに変更
        self.final_activation = nn.Tanh()  # 出力を-1〜1にスケーリング
